 ...
 */
public class PutNextCreatorSupply extends AsyncTask<String, Void, String> {
    Activity linkedActivity;
    Context context;
    private String nameGame;

    public PutNextCreatorSupply(Activity linkedActivity, Context context, String nameGame) {
