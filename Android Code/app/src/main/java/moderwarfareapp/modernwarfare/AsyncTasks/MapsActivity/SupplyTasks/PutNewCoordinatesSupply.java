 ...
 */
public class PutNewCoordinatesSupply extends AsyncTask<String, Void, String> {
    Activity linkedActivity;
    private String nameGame;
    private String latitude;
    private String longitude;

    public PutNewCoordinatesSupply(Activity linkedActivity, String nameGame, String latitude, String longitude) {
