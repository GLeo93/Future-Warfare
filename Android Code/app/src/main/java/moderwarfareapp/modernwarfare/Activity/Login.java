...
public class Login extends AppCompatActivity {
    ...
    private final static String TAG = Login.class.getName().toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FacebookSdk.sdkInitialize(getApplicationContext(), new FacebookSdk.InitializeCallback() {
            ...
            public void onInitialized() {
                ...
                if (accessToken == null) {
                    ...
                    Log.d(TAG, "Logged in");
                    Intent main = new Intent(Login.this,UserMenu.class);
                    startActivity(main);
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                //Once authorized from facebook will directly go to UserMenu
        ...
        // into https://developers.facebook.com/quickstarts/1566461916996568/?platform=android
        showHashKey(this);
    ...
    public static void showHashKey(Context context) {
        try {
            PackageInfo info = context.getPackageManager().getPackageInfo(
                    "moderwarfareapp.modernwarfare", PackageManager.GET_SIGNATURES); //Your package name here
